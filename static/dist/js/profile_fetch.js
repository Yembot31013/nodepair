...
function recommendMeta(el, video, price, title, profile, fullname, url) {
  el.append(`<div class="col-md-6 col-lg-6">
...
var endpoint2 = `/profileMeta/${query}/`
var endpoint3 = `/profileProject/${query}/`

var all = $("#profileAll")
let el_all_doc = document.querySelector("#profileAll")

var meta = $("#profileMeta")
let el_meta_doc = document.querySelector("#profileMeta")

var project = $("#profileProject")
let el_project_doc = document.querySelector("#profileProject")
